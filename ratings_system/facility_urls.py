...
urlpatterns = patterns(
    ...
    url(r'^(?P<gid>\d+)/facility_review_posted/',
        views.facility_review_posted, name='facility_review_posted'),
    url(r'^(?P<gid>\d+)/(<html_name>facility\_review\_error)/',
        views.facility_unary_view),
